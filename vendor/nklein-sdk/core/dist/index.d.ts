 ...
 */
export * as Llms from "@nklein/llms";
...
AgentExtensionCommand, AgentExtensionCommand as AgentPluginCommand, AgentHooks, AgentMode, AgentResult, AgentRunResult, AgentRunStatus, AgentToolContext, AutomationEventEnvelope, BasicLogger, ChatRunTurnRequest, ChatRuntimeConfig, ChatStartSessionArtifacts, ChatStartSessionRequest, ChatTurnResult, NKleinAccountActionRequest, ConnectorHookEvent, ContentBlock, EnterpriseAuthenticateRequest, EnterpriseAuthenticateResponse, EnterpriseStatusRequest, EnterpriseStatusResponse, EnterpriseSyncRequest, EnterpriseSyncResponse, FileContent, GetProviderModelsActionRequest, HookSessionContext, ImageContent, ITelemetryService, ListProvidersActionRequest, Message, MessageWithMetadata, OAuthProviderId, ProviderActionRequest, ProviderCatalogResponse, ProviderListItem, ProviderModel, ProviderOAuthLoginResponse, RuntimeLoggerConfig, SaveProviderSettingsActionRequest, SessionLineage, TEAM_LIFECYCLE_EVENT_TYPE, TEAM_PROGRESS_EVENT_TYPE, TeamProgressProjectionEvent, TelemetryArray, TelemetryMetadata, TelemetryObject, TelemetryPrimitive, TelemetryProperties, TelemetryValue, TextContent, ThinkingContent, ToolApprovalRequest, ToolApprovalResult, ToolPolicy, ToolResultContent, ToolUseContent, WorkspaceInfo, WorkspaceInfoSchema, WorkspaceManifest, WorkspaceManifestSchema, } from "@nklein/shared";
export { buildNKleinSystemPrompt as getNKleinDefaultSystemPrompt, ContributionRegistry, createNKleinTelemetryServiceConfig, createNKleinTelemetryServiceMetadata, createContributionRegistry, createTool, emptyWorkspaceManifest, formatDisplayUserInput, noopBasicLogger, normalizeUserInput, parseUserCommandEnvelope, registerDisposable, } from "@nklein/shared";
export * from "@nklein/shared/storage";
export { type NKleinAccountBalance, type NKleinAccountOperations, type NKleinAccountOrganization, type NKleinAccountOrganizationBalance, type NKleinAccountOrganizationUsageTransaction, type NKleinAccountPaymentTransaction, NKleinAccountService, type NKleinAccountServiceOptions, type NKleinAccountUsageTransaction, type NKleinAccountUser, type NKleinOrganization, executeNKleinAccountAction, type FeaturebaseTokenResponse, isNKleinAccountActionRequest, type ProviderActionExecutor, RpcNKleinAccountService, type UserRemoteConfigOrganization, type UserRemoteConfigResponse, } from "./account";
export { createOAuthClientCallbacks, type OAuthClientCallbacksOptions, } from "./auth/client";
export { completeNKleinDeviceAuth, createNKleinOAuthProvider, getValidNKleinCredentials, loginNKleinOAuth, refreshNKleinToken, startNKleinDeviceAuth, } from "./auth/nklein";
...
export { addLocalProvider, type DeleteLocalProviderRequest, deleteLocalProvider, ensureCustomProvidersLoaded, getLocalProviderModels, getProviderConfigFields, listLocalProviders, loginLocalProvider, normalizeOAuthProvider, type ProviderConfigFieldKey, type ProviderConfigFieldRequirement, type ProviderConfigFields, refreshProviderModelsFromSource, resolveLocalNKleinAuthToken, saveLocalProviderOAuthCredentials, saveLocalProviderSettings, type UpdateLocalProviderRequest, updateLocalProvider, } from "./services/providers/local-provider-service";
...
export type { TelemetryAgentIdentityProperties, TelemetryAgentKind, WorkspaceInitErrorProperties, WorkspaceInitializedProperties, WorkspacePathResolvedProperties, } from "./services/telemetry/core-events";
export { CORE_TELEMETRY_EVENTS, captureAgentCreated, captureAgentTeamCreated, captureAuthFailed, captureAuthLoggedOut, captureAuthStarted, captureAuthSucceeded, captureConversationTurnEvent, captureDiffEditFailure, captureExtensionActivated, captureHookDiscovery, captureMentionFailed, captureMentionSearchResults, captureMentionUsed, captureModeSwitch, captureProviderApiError, captureSkillUsed, captureSubagentExecution, captureTaskCompleted, captureTaskCreated, captureTaskRestarted, captureTokenUsage, captureToolUsage, captureWorkspaceInitError, captureWorkspaceInitialized, captureWorkspacePathResolved, identifyAccount, } from "./services/telemetry/core-events";
...
export declare function loadOpenTelemetryAdapter(): Promise<typeof import("./services/telemetry/index.js")>;
export { Agent, createAgentRuntime } from "@nklein/agents";
export { createContextCompactionPrepareTurn } from "./extensions/context/compaction";
export { ALL_DEFAULT_TOOL_NAMES, type AskQuestionExecutor, type BuiltinToolAvailabilityContext, type CreateBuiltinToolsOptions, type CreateDefaultToolsOptions, createBuiltinTools, createDefaultExecutors, createDefaultTools, createDefaultToolsWithPreset, createToolPoliciesWithPreset, type DefaultExecutorsOptions, type DefaultToolName, DefaultToolNames, type DefaultToolsConfig, getCoreAcpToolNames, getCoreBuiltinToolCatalog, getCoreDefaultEnabledToolIds, getCoreHeadlessToolNames, resolveCoreSelectedToolIds, TEAM_TOOL_NAMES, type ToolCatalogEntry, type ToolExecutors, type ToolPolicyPresetName, type ToolPresetName, ToolPresets, } from "./extensions/tools";
export { type NKleinRecommendedModel, type NKleinRecommendedModelsData, FALLBACK_NKLEIN_RECOMMENDED_MODELS, type FetchNKleinRecommendedModelsOptions, fetchNKleinRecommendedModels, } from "./services/llms/nklein-recommended-models";
...
export { createLlmsSdk, DefaultLlmsSdk, } from "./services/llms/runtime-registry";
export type { BuiltInProviderSummary, CreateHandlerInput, LlmsConfig, LlmsSdk, ProviderConfigDefaults, ProviderSelectionConfig, RegisterBuiltinProviderInput, RegisteredProviderSummary, RegisterModelInput, RegisterProviderInput, } from "./services/llms/runtime-types";
export { TelemetryService, type TelemetryServiceOptions, } from "./services/telemetry/TelemetryService";
