import type { AgentConfig, AgentHooks, AgentResult, AgentTool, BasicLogger, ITelemetryService, RuntimeConfigExtensionKind } from "@nklein/shared";
 ...
 * callback exercises; avoids depending on `@nklein/agents`' `Agent`
