/**
 * Telemetry adapter interface for the @nklein/core SDK.
 *
 ...
 */
import type { TelemetryProperties } from "@nklein/shared";
export type { TelemetryArray, TelemetryMetadata, TelemetryObject, TelemetryPrimitive, TelemetryProperties, TelemetryValue, } from "@nklein/shared";
/**
 * Telemetry adapter that an SDK consumer implements (or uses via the
 * provided {@link OpenTelemetryAdapter}) to receive NKlein telemetry events.
 *
