 ...
 *
 * - `one_off`: a single run materialized from a `.nklein/cron/*.md` spec.
 * - `schedule`: recurring runs materialized from a `.nklein/cron/*.cron.md` spec.
 * - `event`: reactive runs materialized from a `.nklein/cron/events/*.event.md`
...
export interface AutomationSpecSource {
    /**
     * POSIX-normalized path of the source file relative to `.nklein/cron/`.
