...
/**
 * The IDE or client surface the user is running NKlein from.
 */
export type ClientName = "nklein-vscode" | "nklein-jetbrains" | "nklein-cli" | "nklein-sdk" | "nklein-kanban" | "nklein-acp" | "nklein-platform" | (string & {});
/**
 * Identity of the calling client (surface + version).
 */
export interface ClientContext {
    /** e.g. "nklein-vscode", "nklein-cli", "nklein-sdk" */
    name: ClientName;
 ...
 * required by buildNKleinSystemPrompt, so callers can spread a WorkspaceInfo
...
export interface WorkspaceContext extends WorkspaceInfo {
    ...
    /**
     * Pre-serialized workspace metadata block that replaces {{NKLEIN_METADATA}}
...
export interface ExtensionContext {
     ...
     * started through a NKleinCore instance with automation enabled.
     */
