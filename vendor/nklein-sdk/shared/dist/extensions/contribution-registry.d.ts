...
export interface PluginSetupContext {
    ...
    /** Host/client identity such as `nklein-cli`, `nklein-vscode`, or an SDK app. */
    ...
    /**
     * Automation ingress made available by hosts that enable NKleinCore
 ...
 * (e.g. `AgentExtension` in `@nklein/agents`) narrow them to the correct
...
export interface ContributionRegistryExtension<TTool = AgentTool, TMessage = unknown> {
    ...
    disabled?: boolean;
    /** Runtime-native hooks consumed directly by `@nklein/agents`. */
