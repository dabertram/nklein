import type { ModelCollection, ModelInfo, ProviderInfo } from "../catalog/types";
...
export declare const MODEL_COLLECTIONS_BY_PROVIDER_ID: Record<string, ModelCollection>;
