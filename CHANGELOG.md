...
- Treated sandbox result-patch capture failures as benign when the workspace was already disposed concurrently, avoiding misleading runtime-error warnings while preserving real capture failures.
