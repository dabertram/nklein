...
- Added discard cleanup for sandbox task result branches, threading `preserveChanges=false` through permanent task delete, Clear Trash, project removal, and dev cleanup while leaving ordinary move-to-trash cleanup on the preserving path.
