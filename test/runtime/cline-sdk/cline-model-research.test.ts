...
import {
	buildClineModelFreshnessAdvisorRequest,
	summarizeClineModelRegistryForResearch,
} from "../../../src/cline-sdk/cline-model-research";

function createSnapshot(): ClineModelRegistrySnapshot {
	return {
		schemaVersion: 1,
		updatedAt: 20,
		models: {
...
describe("cline model research", () => {
	it("summarizes the model registry for model-freshness research", () => {
		expect(summarizeClineModelRegistryForResearch(createSnapshot())).toContain(
