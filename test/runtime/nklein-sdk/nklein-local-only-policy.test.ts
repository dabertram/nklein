...
import {
	...
	isLocalProvider,
	LOCAL_PROVIDER_IDS,
} from "../../../src/nklein-sdk/nklein-local-only-policy";
...
const CLOUD_LITERAL_ALLOWLIST = new Map<string, string>([
	...
	[
		"src/nklein-sdk/nklein-web-research-tool.ts",
