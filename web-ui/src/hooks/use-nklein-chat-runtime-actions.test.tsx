...
interface HookSnapshot {
	sendTaskChatMessage: ReturnType<typeof useNKleinChatRuntimeActions>["sendTaskChatMessage"];
	loadTaskChatMessages: ReturnType<typeof useNKleinChatRuntimeActions>["loadTaskChatMessages"];
	abortTaskChatTurn: ReturnType<typeof useNKleinChatRuntimeActions>["abortTaskChatTurn"];
	cancelTaskChatTurn: ReturnType<typeof useNKleinChatRuntimeActions>["cancelTaskChatTurn"];
}
...
function HookHarness({
	...
	const state = useNKleinChatRuntimeActions({
		currentProjectId,
		onSessionSummary,
	});
...
describe("useNKleinChatRuntimeActions", () => {
