					...
					return (
						<div key={project.id} className="rounded-md border border-border bg-surface-2 px-2.5 py-2">
							<div className="flex items-start justify-between gap-2">
								<div className="min-w-0">
									<p className="m-0 break-words text-xs font-semibold text-text-primary">{project.name}</p>
									<p className="mt-1 mb-0 break-words font-mono text-[10px] text-text-tertiary">
										{parentPath}
									</p>
								</div>
								<span
