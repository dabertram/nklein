import { getNKleinToolCallDisplay } from "@runtime-nklein-tool-call-display";
...
describe("getToolSummary", () => {
	it("parses structured tool calls through the shared runtime helper", () => {
		expect(
			getNKleinToolCallDisplay("fetch_web_content", {
...
describe("nklein command display", () => {
	...
	it("works with getNKleinToolCallDisplay directly for nklein commands", () => {
		const display = getNKleinToolCallDisplay("run_commands", {
