export type NKleinComposerCompletionKind = "mention" | "slash";

export interface ActiveNKleinComposerToken {
	kind: NKleinComposerCompletionKind;
	start: number;
	end: number;
	query: string;
}

export interface NKleinComposerCompletionSuggestion {
	id: string;
	kind: NKleinComposerCompletionKind;
	label: string;
	detail?: string;
...
export function detectActiveNKleinComposerToken(value: string, cursorIndex: number): ActiveNKleinComposerToken | null {
...
export function applyNKleinComposerCompletion(
	value: string,
	token: ActiveNKleinComposerToken,
	replacement: string,
