import { getNKleinToolCallDisplay, type NKleinToolCallDisplay } from "@runtime-nklein-tool-call-display";
 ...
 * Uses tool-specific logic for known NKlein SDK tools, then falls back to generic extraction.
 */
export function getToolSummary(toolName: string, input: string | null, output?: string | null): string | null {
	return getNKleinToolCallDisplay(toolName, input, output).inputSummary;
}
 ...
 */
export function getToolDisplay(toolName: string, input: string | null, output?: string | null): NKleinToolCallDisplay {
	return getNKleinToolCallDisplay(toolName, input, output);
}
