...
import type { RuntimeNKleinReasoningEffort } from "@/runtime/types";
...
export function NKleinChatModelSelector({
	modelOptions,
	recommendedModelIds = [],
					...
					>
						...
						{selectedModelSupportsReasoningEffort ? (
							<div className="p-2">
								...
								<div className="p-1">
									{NKLEIN_REASONING_EFFORT_OPTIONS.map((option) => {
										...
										return (
											<button
												...
												onClick={() => {
													onSelectReasoningEffort(option.value as RuntimeNKleinReasoningEffort | "");
													handleOpenChange(false);
												}}
											>
												<span className="flex-1">
													{formatNKleinReasoningEffortLabel(
														option.value as RuntimeNKleinReasoningEffort | "",
													)}
												</span>
												{isSelected ? <Check size={14} className="shrink-0 text-accent-fg" /> : null}
											</button>
