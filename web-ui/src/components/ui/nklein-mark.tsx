export function NKleinMark({ size = 20, className }: { size?: number; className?: string }): React.ReactElement {
	return (
		<svg width={size} height={size} viewBox="0 0 92 95" fill="currentColor" className={className} aria-hidden>
			<path
