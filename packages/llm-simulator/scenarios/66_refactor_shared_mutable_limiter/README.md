# 66_refactor_shared_mutable_limiter — recorded scenario set

Recorded from a real HITL rig drive (requests 2804+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=66_refactor_shared_mutable_limiter npx tsx scripts/verify-simulated-flow.mts
```
