# 65_refactor_report_pipeline_god_module — recorded scenario set

Recorded from a real HITL rig drive (requests 2788+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=65_refactor_report_pipeline_god_module npx tsx scripts/verify-simulated-flow.mts
```
