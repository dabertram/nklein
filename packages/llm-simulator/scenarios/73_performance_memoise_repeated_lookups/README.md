# 73_performance_memoise_repeated_lookups — recorded scenario set

Recorded from a real HITL rig drive (requests 3004+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=73_performance_memoise_repeated_lookups npx tsx scripts/verify-simulated-flow.mts
```
