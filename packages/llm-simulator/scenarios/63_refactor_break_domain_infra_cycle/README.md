# 63_refactor_break_domain_infra_cycle — recorded scenario set

Recorded from a real HITL rig drive (requests 2756+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=63_refactor_break_domain_infra_cycle npx tsx scripts/verify-simulated-flow.mts
```
