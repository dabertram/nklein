# 54_planning_encrypted_backup_restore — recorded scenario set

Recorded from a real HITL rig drive (requests 2898+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=54_planning_encrypted_backup_restore npx tsx scripts/verify-simulated-flow.mts
```
