# 45_analysis_dataset_quality_audit — recorded scenario set

Recorded from a real HITL rig drive (requests 1775+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=45_analysis_dataset_quality_audit npx tsx scripts/verify-simulated-flow.mts
```
