# 68_integration_retry_backoff_rate_limit — recorded scenario set

Recorded from a real HITL rig drive (requests 2829+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=68_integration_retry_backoff_rate_limit npx tsx scripts/verify-simulated-flow.mts
```
