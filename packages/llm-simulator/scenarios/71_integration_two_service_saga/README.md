# 71_integration_two_service_saga — recorded scenario set

Recorded from a real HITL rig drive (requests 2989+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=71_integration_two_service_saga npx tsx scripts/verify-simulated-flow.mts
```
