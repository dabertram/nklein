# 67_integration_paging_contacts_adapter — recorded scenario set

Recorded from a real HITL rig drive (requests 2821+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=67_integration_paging_contacts_adapter npx tsx scripts/verify-simulated-flow.mts
```
