# 38_tests_duration_schedule_suite — recorded scenario set

Recorded from a real HITL rig drive (requests 865+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=38_tests_duration_schedule_suite npx tsx scripts/verify-simulated-flow.mts
```
