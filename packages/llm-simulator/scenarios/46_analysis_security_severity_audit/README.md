# 46_analysis_security_severity_audit — recorded scenario set

Recorded from a real HITL rig drive (requests 1804+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=46_analysis_security_severity_audit npx tsx scripts/verify-simulated-flow.mts
```
