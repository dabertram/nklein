# 58_repair_inventory_allocation_defects — recorded scenario set

Recorded from a real HITL rig drive (requests 2577+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=58_repair_inventory_allocation_defects npx tsx scripts/verify-simulated-flow.mts
```
