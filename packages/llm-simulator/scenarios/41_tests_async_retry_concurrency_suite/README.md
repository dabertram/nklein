# 41_tests_async_retry_concurrency_suite — recorded scenario set

Recorded from a real HITL rig drive (requests 2208+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=41_tests_async_retry_concurrency_suite npx tsx scripts/verify-simulated-flow.mts
```
