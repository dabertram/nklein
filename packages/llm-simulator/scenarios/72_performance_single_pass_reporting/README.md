# 72_performance_single_pass_reporting — recorded scenario set

Recorded from a real HITL rig drive (requests 2996+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=72_performance_single_pass_reporting npx tsx scripts/verify-simulated-flow.mts
```
