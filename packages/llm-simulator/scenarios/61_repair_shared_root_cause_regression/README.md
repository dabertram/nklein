# 61_repair_shared_root_cause_regression — recorded scenario set

Recorded from a real HITL rig drive (requests 2722+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=61_repair_shared_root_cause_regression npx tsx scripts/verify-simulated-flow.mts
```
