# 53_planning_warehouse_stock_ledger — recorded scenario set

Recorded from a real HITL rig drive (requests 2884+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=53_planning_warehouse_stock_ledger npx tsx scripts/verify-simulated-flow.mts
```
