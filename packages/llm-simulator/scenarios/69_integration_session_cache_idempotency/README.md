# 69_integration_session_cache_idempotency — recorded scenario set

Recorded from a real HITL rig drive (requests 2835+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=69_integration_session_cache_idempotency npx tsx scripts/verify-simulated-flow.mts
```
