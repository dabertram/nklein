# 49_spec_contradiction_hunt — recorded scenario set

Recorded from a real HITL rig drive (requests 1934+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=49_spec_contradiction_hunt npx tsx scripts/verify-simulated-flow.mts
```
