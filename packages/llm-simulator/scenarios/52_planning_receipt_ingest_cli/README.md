# 52_planning_receipt_ingest_cli — recorded scenario set

Recorded from a real HITL rig drive (requests 2871+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=52_planning_receipt_ingest_cli npx tsx scripts/verify-simulated-flow.mts
```
