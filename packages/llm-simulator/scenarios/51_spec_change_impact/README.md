# 51_spec_change_impact — recorded scenario set

Recorded from a real HITL rig drive (requests 2455+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=51_spec_change_impact npx tsx scripts/verify-simulated-flow.mts
```
