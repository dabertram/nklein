# 55_planning_payments_reconciliation — recorded scenario set

Recorded from a real HITL rig drive (requests 2922+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=55_planning_payments_reconciliation npx tsx scripts/verify-simulated-flow.mts
```
