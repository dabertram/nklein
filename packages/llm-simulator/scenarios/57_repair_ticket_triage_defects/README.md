# 57_repair_ticket_triage_defects — recorded scenario set

Recorded from a real HITL rig drive (requests 2950+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=57_repair_ticket_triage_defects npx tsx scripts/verify-simulated-flow.mts
```
