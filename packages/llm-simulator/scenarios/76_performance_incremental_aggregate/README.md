# 76_performance_incremental_aggregate — recorded scenario set

Recorded from a real HITL rig drive (requests 3027+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=76_performance_incremental_aggregate npx tsx scripts/verify-simulated-flow.mts
```
