# 56_planning_fleet_telemetry_platform — recorded scenario set

Recorded from a real HITL rig drive (requests 2935+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=56_planning_fleet_telemetry_platform npx tsx scripts/verify-simulated-flow.mts
```
