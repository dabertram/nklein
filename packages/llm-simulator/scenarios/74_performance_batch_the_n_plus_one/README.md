# 74_performance_batch_the_n_plus_one — recorded scenario set

Recorded from a real HITL rig drive (requests 3012+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=74_performance_batch_the_n_plus_one npx tsx scripts/verify-simulated-flow.mts
```
