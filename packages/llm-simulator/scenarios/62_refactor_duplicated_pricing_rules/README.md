# 62_refactor_duplicated_pricing_rules — recorded scenario set

Recorded from a real HITL rig drive (requests 2739+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=62_refactor_duplicated_pricing_rules npx tsx scripts/verify-simulated-flow.mts
```
