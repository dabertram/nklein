# 37_tests_pricing_rules_suite — recorded scenario set

Recorded from a real HITL rig drive (requests 800+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=37_tests_pricing_rules_suite npx tsx scripts/verify-simulated-flow.mts
```
