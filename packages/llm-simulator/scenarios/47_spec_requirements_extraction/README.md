# 47_spec_requirements_extraction — recorded scenario set

Recorded from a real HITL rig drive (requests 1835+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=47_spec_requirements_extraction npx tsx scripts/verify-simulated-flow.mts
```
