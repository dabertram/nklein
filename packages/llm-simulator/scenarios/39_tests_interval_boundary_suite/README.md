# 39_tests_interval_boundary_suite — recorded scenario set

Recorded from a real HITL rig drive (requests 1474+ of `/Users/david/.nklein/factory-drains/hitl-drain/queue`), reshaped by
...
```bash
NKLEIN_SIMFLOW_SCENARIO=39_tests_interval_boundary_suite npx tsx scripts/verify-simulated-flow.mts
```
