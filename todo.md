...
- [ ] **F12.2 — De-emphasize embedding retrieval for short keyword queries.** CoREB (May 2026) found short keyword queries —
...
- [ ] **F12.3 — Adopt Aider-style PageRank repo-map ranking with a token budget.** Aider ranks symbols via personalized
...
- [ ] **F12.5 — Rubric-guided verification as a review lens.** "Agentic rubrics as contextual verifiers" give consistent
