...
**Live status clarification (2026-07-21, after F11.2h):** `[ ]` means executable now, not merely “not started”; `[~]`
means executable residue and is the current priority; `[>]` means do not start until its inline or phase-inherited gate
below is green. The current 201-package remainder is **102 ready + 11 partial + 77 dependency-blocked + 6 external/user-
