...
export const NKLEIN_RUNTIME_HOME_DIR_NAME = `${CLINE_HOME_DIR_NAME}/${NKLEIN_RUNTIME_DIR_NAME}`;
export const LEGACY_KANBAN_RUNTIME_HOME_DIR_NAME = `${CLINE_HOME_DIR_NAME}/${LEGACY_KANBAN_RUNTIME_DIR_NAME}`;
