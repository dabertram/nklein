...
// Git history contract domain: commit + ref shapes, git-log request/response, and commit-diff
// (file / request / response) + the refs response. Split out of api-contract.ts (§5.X #2). Imports z +
// task-workspace-info (the task scope) from projects — never the barrel.
