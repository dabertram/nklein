...
export const OPERATIONAL_OBSERVATION_CATEGORIES: readonly string[] = [
	...
	// 2026-09-09: a pool container was retired. Recorded to test whether a retirement with a queued waiter explains
	...
	// Inherited debt (2026-09-08): a waived pre-existing breakage was opened, re-encountered or closed.
	"inherited_debt",
