...
import {
	...
	runtimeMemoryFreshnessAuditSchema,
...
export const runtimeConfigResponseSchema = z.object({
	...
	// P17.7 residency budgets: KV-cache disk tier budget in whole GB (mlx-serve --prefix-cache-disk); null = off.
	kvCacheDiskGb: z.number().int().positive().nullable().optional(),
	...
	fleetDecompositionDefaults: runtimeFleetDecompositionSettingsSchema.optional(),
	fleetDecompositionOverride: runtimeFleetDecompositionSettingsSchema.nullable().optional(),
	effectiveFleetDecompositionSettings: runtimeFleetDecompositionSettingsSchema.optional(),
	...
	memoryFreshnessAudit: runtimeMemoryFreshnessAuditSchema,
...
export const runtimeConfigSaveRequestSchema = z.object({
	...
	memoryFreshnessAudit: runtimeMemoryFreshnessAuditSchema.optional(),
...
export const runtimeHostActionConfirmPendingSchema = z.object({
	...
	expiresAt: z.number(),
	// F2.12b DISPLAY-ONLY enrichment (from describeHostActionConfirmation): typed action, effect, and duration.
