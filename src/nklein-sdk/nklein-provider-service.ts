...
import { getDefaultNKleinModelRegistry, type NKleinModelRegistryEntry } from "./nklein-model-registry";
...
function toLmStudioModel(item: unknown, pathname: LmStudioModelListPathname): RuntimeNKleinProviderModel | null {
...
function toLmStudioModels(item: unknown, pathname: LmStudioModelListPathname): RuntimeNKleinProviderModel[] {
...
function extractDiscoveredModelsFromPayload(value: unknown, sourceUrl: string): RuntimeNKleinProviderModel[] {
	const pathname = (() => {
		try {
