...
!Klein specifics:
- Runtime security code usually lives in \`src/security/\`, \`src/server/\`, \`src/core/agent-write-guard.ts\`, and \`src/nklein-sdk/\`.
...
- Keep boundaries clear: NKlein SDK specifics belong behind \`src/nklein-sdk/sdk-runtime-boundary.ts\` and adjacent adapter modules.
