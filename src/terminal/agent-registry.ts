...
export function buildRuntimeConfigResponse(
	...
	return {
		...
		sandboxIsolationProfileDefault: runtimeConfig.sandboxIsolationProfileDefault,
		sandboxIsolationProfileOverride: runtimeConfig.sandboxIsolationProfileOverride,
		effectiveSandboxIsolationProfile: runtimeConfig.effectiveSandboxIsolationProfile,
		...
		sandboxMcpServersEnabledOverride: runtimeConfig.sandboxMcpServersEnabledOverride,
		effectiveSandboxMcpServersEnabled: runtimeConfig.effectiveSandboxMcpServersEnabled,
		sandboxMcpServerOverrides: runtimeConfig.sandboxMcpServerOverrides,
		effectiveSandboxMcpServerControls: runtimeConfig.effectiveSandboxMcpServerControls,
		basicMemoryEnabled: runtimeConfig.basicMemoryEnabled,
		chatAdaptiveTruncationEnabled: runtimeConfig.chatAdaptiveTruncationEnabled,
		reasoningBudgetEnabled: runtimeConfig.reasoningBudgetEnabled,
