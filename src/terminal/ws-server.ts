...
export interface CreateTerminalWebSocketBridgeRequest {
	 ...
	 * @param request - The full upgrade request, so the validator can inspect the session
	 *   cookie AND the socket peer address (loopback callers bypass the passcode gate).
