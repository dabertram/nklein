...
import type { LocalLlmChatMessage, LocalLlmSamplingOptions } from "./nklein-local-llm-client";

/**
 * TS client for the !Klein Python core sidecar (`core-py`).
 *
 * The sidecar owns the capabilities the NKlein SDK can't provide — most importantly grammar / JSON-schema
