 ...
 *
 * Why this exists: the bundled Cline SDK drives the main agent loop, but its LLM layer only forwards
 ...
 * is a separate, additive path !Klein controls. It does NOT replace the Cline agent loop; it is used for
