import type { RuntimeTaskClineSettings } from "../core/api-contract";
import {
	classifyDevTestRun,
...
import type { ClineDevTestProjectScenario } from "./cline-dev-test-project";
...
export function buildDevTestSeedStartPayload(options: BuildDevTestSeedStartPayloadOptions): DevTestSeedStartPayload {
	return {
		...
		agentId: options.agentId ?? "cline",
		...(options.clineSettings ? { clineSettings: options.clineSettings } : {}),
	};
}
