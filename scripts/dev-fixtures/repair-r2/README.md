# Repair fixture — interacting defects across an inventory allocator

`src/` holds three modules with one seeded defect each. They interact: fixing the first in the obvious way turns a
scenario that was green red, because the second defect stops being masked. Repair all of them.
