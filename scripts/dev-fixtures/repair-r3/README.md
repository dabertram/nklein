# Repair fixture — a race, a floating promise and a swallowed error

`src/` is an async job pipeline with three seeded defects. All timing goes through the injected `io` seam; nothing
here may sleep, poll or read the clock, and neither may your repair.
